...
public class ActiBoard extends AppCompatActivity {
    /* 로그 테스트 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab_lvBoard.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /* 게시글 보기로 이동*/
                Intent i = new Intent(ActiBoard.this, ActiBoardContent.class);
                startActivity(i);
            }
        });
        ...
        ab_btnWrite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* 글쓰기 창으로 이동 */
                Intent i = new Intent(ActiBoard.this, ActiWrite.class);
                startActivity(i);
            }
        });
    }
    ...
    public class boardServer extends AsyncTask<String, Integer, String> {
        ProgressDialog asyncDialog = new ProgressDialog(ActiBoard.this);
