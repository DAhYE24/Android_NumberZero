...
public class ActiPerfDetail extends AppCompatActivity {
    ...
    /* XML 선언 */
    TextView apd_txtName, apd_txtEng, apd_txtBrand, apd_txtCnP, apd_txtFla;
    TextView apd_txtIntro, apd_txtType, apd_txtCountry, apd_txtLike; // 텍스트
    Button apd_btnBox, apd_btnPrice, apd_btnLike; // 버튼 : 보관하기, 가격비교, 추천하기
    ImageView apd_imgPerf; // 이미지 : 향수 이미지

    /* JAVA 선언 */
    Boolean userCheck = false; // 유저 체크, false일 때는 로그인 화면
    String perfName, perfEngName, perfPrice, perfBrand, perfFla, perfCountry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acti_perfdetail);

        /* 초기화 */
        apd_txtName = (TextView)findViewById(R.id.apd_txtName);
        apd_txtEng = (TextView)findViewById(R.id.apd_txtEng);
        apd_txtBrand = (TextView)findViewById(R.id.apd_txtBrand);
        apd_txtCnP = (TextView)findViewById(R.id.apd_txtCnP);
        apd_txtFla = (TextView)findViewById(R.id.apd_txtFla);
        apd_txtIntro = (TextView)findViewById(R.id.apd_txtIntro);
        apd_txtType = (TextView)findViewById(R.id.apd_txtType);
        apd_btnBox = (Button)findViewById(R.id.apd_btnBox);
        apd_btnPrice = (Button)findViewById(R.id.apd_btnPrice);
        apd_btnLike = (Button)findViewById(R.id.apd_btnLike);
        apd_imgPerf = (ImageView)findViewById(R.id.apd_imgPerf);
        apd_txtCountry = (TextView)findViewById(R.id.apd_txtCountry);
        apd_txtLike = (TextView)findViewById(R.id.apd_txtLike);
        ...
        /* 가격비교 버튼 클릭 */
        apd_btnPrice.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        /* 추천하기 버튼 클릭 */
        apd_btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(userCheck == false) {
        ...
        /* 보관하기 버튼 클릭 */
        apd_btnBox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(userCheck == false) {
                    Toast.makeText(ActiPerfDetail.this, "해당 기능은 넘버제로 회원만 사용할 수 있습니다.", Toast.LENGTH_SHORT).show();
    ...
    private void putPerfumeInfo() {
        try{
            ...
            Glide.with(ActiPerfDetail.this).load(perfImage).override(100, 100).into(apd_imgPerf);

            /* 이미 등록된 경우에는 선택된 버튼으로 변경 */
            if(vLike.equals("1"))   apd_btnLike.setBackgroundResource(R.drawable.sbtn_samplechecked);
            if(vBox.equals("1"))    apd_btnBox.setBackgroundResource(R.drawable.sbtn_samplechecked);

            apd_txtName.setText(perfName);
            apd_txtEng.setText(perfEngName);
            apd_txtBrand.setText(perfBrand);
            apd_txtCnP.setText(perfCapacity + " / " + perfPrice + "원");
            apd_txtLike.setText("추천 " + perfLike);
            apd_txtType.setText(perfType);
            apd_txtCountry.setText(perfCountry);
            ...
            apd_txtFla.setText(TextViewHelper.shrinkWithWordUnit(apd_txtFla, perfFla, width - 150));
            //apd_txtFla.setText(perfFla);
            //apd_txtIntro.setText(perfIntro);
            apd_txtIntro.setText(TextViewHelper.shrinkWithWordUnit(apd_txtIntro, perfIntro, width - 150));
        ...
        protected void onPostExecute(String str){
            ...
            if(phpChk == 0) { // 향수 추천
                if(str.trim().equals("100")) {
                    ...
                    apd_txtLike.setText("추천 " +  String.valueOf(tempLike));
                    apd_btnLike.setBackgroundResource(R.drawable.sbtn_samplechecked);
                    vLike = "1";
                ...
                if(str.trim().equals("100")) {
                    ...
                    apd_btnBox.setBackgroundResource(R.drawable.sbtn_samplechecked);
                    vBox = "1";
                }else{
                    Toast.makeText(ActiPerfDetail.this, "실패하였습니다", Toast.LENGTH_SHORT).show();
                }
                ...
                if(str.trim().equals("100")) {
                    ...
                    apd_txtLike.setText("추천 " +  String.valueOf(tempLike));
                    apd_btnLike.setBackgroundResource(R.drawable.sbtn_sample);
                    vLike = "0";
                }else{
                    Toast.makeText(ActiPerfDetail.this, "실패하였습니다", Toast.LENGTH_SHORT).show();
                }
                ...
                if(str.trim().equals("100")) {
                    ...
                    apd_btnBox.setBackgroundResource(R.drawable.sbtn_sample);
                    vBox = "0";
                }else{
                    Toast.makeText(ActiPerfDetail.this, "실패하였습니다", Toast.LENGTH_SHORT).show();
                }
